...
spellObject.onMobSpawn = function(mob)
    ...
    if mlvl > 9 then
        mob:addSimpleGambit(ai.t.TARGET, ai.r.JA, ai.s.SPECIFIC, xi.ja.JUMP)
    end
    if mlvl > 34 then
        mob:addSimpleGambit(ai.t.TARGET, ai.r.JA, ai.s.SPECIFIC, xi.ja.HIGH_JUMP)
    end
    if mlvl > 76 then
        mob:addSimpleGambit(ai.t.TARGET, ai.r.JA, ai.s.SPECIFIC, xi.ja.SPIRIT_JUMP)
    end
    if mlvl > 84 then
        mob:addSimpleGambit(ai.t.TARGET, ai.r.JA, ai.s.SPECIFIC, xi.ja.SOUL_JUMP)
    end
