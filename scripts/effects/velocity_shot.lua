...
effectObject.onEffectGain = function(target, effect)
    ...
    target:addMod(xi.mod.ATTP, -40)
    target:addMod(xi.mod.HASTE_ABILITY, -1500)
    target:addMod(xi.mod.RATTP, 40)
    target:addMod(xi.mod.RANGED_DELAYP, -30)
end
...
effectObject.onEffectLose = function(target, effect)
    ...
    target:delMod(xi.mod.ATTP, -40)
    target:delMod(xi.mod.HASTE_ABILITY, -1500)
    target:delMod(xi.mod.RATTP, 40)
    target:delMod(xi.mod.RANGED_DELAYP, -30)
end
