...
effectObject.onEffectGain = function(target, effect)
    ...
    if not (target:hasStatusEffect(xi.effect.TABULA_RASA)) then
        target:addMod(xi.mod.BLACK_MAGIC_COST, -30)--  -10
        target:addMod(xi.mod.BLACK_MAGIC_CAST, -30)--  -10
        target:addMod(xi.mod.BLACK_MAGIC_RECAST, -30)--  -10
        target:addMod(xi.mod.WHITE_MAGIC_COST, 30)-- 20
        target:addMod(xi.mod.WHITE_MAGIC_CAST, 30)-- 20
        target:addMod(xi.mod.WHITE_MAGIC_RECAST, 30)-- 20
...
effectObject.onEffectLose = function(target, effect)
    ...
    if not (target:hasStatusEffect(xi.effect.TABULA_RASA)) then
        target:delMod(xi.mod.BLACK_MAGIC_COST, -30)--  -10
        target:delMod(xi.mod.BLACK_MAGIC_CAST, -30)--  -10
        target:delMod(xi.mod.BLACK_MAGIC_RECAST, -30)--  -10
        target:delMod(xi.mod.WHITE_MAGIC_COST, 30)-- 20
        target:delMod(xi.mod.WHITE_MAGIC_CAST, 30)-- 20
        target:delMod(xi.mod.WHITE_MAGIC_RECAST, 30)-- 20
