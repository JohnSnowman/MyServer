...
effectObject.onEffectGain = function(target, effect)
    ...
    target:addMod(xi.mod.TRIPLE_ATTACK, 50)
    target:addMod(xi.mod.TRIPLE_ATTACK_DMG, 50)
    target:addMod(xi.mod.MAIN_DMG_RATING, 45)
...
effectObject.onEffectLose = function(target, effect)
    ...
    target:delMod(xi.mod.TRIPLE_ATTACK, 50)
    target:delMod(xi.mod.TRIPLE_ATTACK_DMG, 50)
    target:delMod(xi.mod.MAIN_DMG_RATING, 45)
