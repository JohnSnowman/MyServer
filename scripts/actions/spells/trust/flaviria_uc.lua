...
spellObject.onMobSpawn = function(mob)
	...
	--local dmgrating	    = trustLevel * 5
    --local dmgrating	    = trustLevel * math.floor((trustLevel + 1) / 11)
    local dmgrating	    = trustLevel * trustLevel
    ...
    mob:addMod(xi.mod.MAIN_DMG_RATING, dmgrating)
...
--	mob:addMod(xi.mod.REGAIN, 75)
	...
	mob:addMod(xi.mod.FORCE_JUMP_CRIT, 100)
	mob:addMod(xi.mod.JUMP_SPIRIT_TP_BONUS, 200)
	mob:addMod(xi.mod.JUMP_SOUL_SPIRIT_ATT_BONUS, 100)
