...
--  Attachment                    Modifier                                0,       1,     2,     3    Optic Fiber Bonus
    ...
    ['arcanoclutch']        = { { xi.mod.MAGIC_DAMAGE,                {    200,    400,    600,    800 }, true  }, },
    ['arcanoclutch_ii']     = { { xi.mod.MAGIC_DAMAGE,                {    400,    600,    800,   1200 }, true  }, },
    ['armor_plate']         = { { xi.mod.DMGPHYS,                     {  -1500,  -1700, -2000, -2500 }, true  }, },
    ['armor_plate_ii']      = { { xi.mod.DMGPHYS,                     { -2500, -3000, -3500, -4000 }, true  }, },
    ['armor_plate_iii']     = { { xi.mod.DMGPHYS,                     { -3500, -4000, -4500, -5000 }, true  }, },
    ['armor_plate_iv']      = { { xi.mod.DMGPHYS,                     { -5000, -5500, -6000, -7000 }, true  }, },
    ...
    ['auto-repair_kit_iv']  = { { xi.mod.HPP,                         {    20,    20,    20,    20 }, false },
                                { xi.mod.REGEN,                       {   nil,   nil,   nil,   nil }, true  }, },
    ['coiler']              = { { xi.mod.DOUBLE_ATTACK,               {     13,    20,    30,    40 }, true  }, },
    ['coiler_ii']           = { { xi.mod.DOUBLE_ATTACK,               {    25,    40,    50,    60 }, true  }, },
    ['damage_gauge']        = { { xi.mod.AUTO_HEALING_THRESHOLD,      {    30,    40,    50,    75 }, true  },
                                { xi.mod.AUTO_HEALING_DELAY,          {     6,     9,     12,    15 }, false }, },
    ['drum_magazine']       = { { xi.mod.AUTO_RANGED_DELAY,           {     9,     12,    15,    18 }, true  }, },
    ['dynamo']              = { { xi.mod.CRITHITRATE,                 {     6,     10,    14,    18 }, true  }, },
    ['dynamo_ii']           = { { xi.mod.CRITHITRATE,                 {     10,   20,    30,    40 }, true  }, },
    ['dynamo_iii']          = { { xi.mod.CRITHITRATE,                 {    20,    30,    50,    70 }, true  }, },
    ...
    ['magniplug']           = { { xi.mod.MAIN_DMG_RATING,             {     50,    150,    300,    450 }, true  },
                                { xi.mod.RANGED_DMG_RATING,           {     50,    150,    300,    450 }, true  }, },
    ['magniplug_ii']        = { { xi.mod.MAIN_DMG_RATING,             {    100,    200,    350,    500 }, true  },
                                { xi.mod.RANGED_DMG_RATING,           {    100,    200,    350,    500 }, true  }, },
    ...
    ['repeater']            = { { xi.mod.DOUBLE_SHOT_RATE,            {    70,    80,    90,   100 }, true  }, },
    ['scanner']             = { { xi.mod.AUTO_SCAN_RESISTS,           {     1,     1,     1,     1 }, false }, },
    ['schurzen']            = { { xi.mod.AUTO_SCHURZEN,               {     1,     1,     1,     1 }, false }, },
    ['scope']               = { { xi.mod.RACC,                        {    100,    200,    300,    400 }, true  }, },
    ['scope_ii']            = { { xi.mod.RACC,                        {    200,    300,    400,    500 }, true  }, },
    ['scope_iii']           = { { xi.mod.RACC,                        {    300,    400,    550,    700 }, true  }, },
    ['scope_iv']            = { { xi.mod.RACC,                        {    400,    500,    650,    800 }, true  }, },
    ...
    ['tactical_processor']  = { { xi.mod.AUTO_DECISION_DELAY,         {    70,    90,   105,   135 }, false }, },
    ['tension_spring']      = { { xi.mod.ATTP,                        {     30,     60,     90,    120 }, true  },
                                { xi.mod.RATTP,                       {     30,     60,     90,    120 }, true  }, },
    ['tension_spring_ii']   = { { xi.mod.ATTP,                        {     60,     90,    120,    150 }, true  },
                                { xi.mod.RATTP,                       {     60,     90,    120,    150 }, true  }, },
    ['tension_spring_iii']  = { { xi.mod.ATTP,                        {    120,    150,    180,    210 }, true  },
                                { xi.mod.RATTP,                       {    120,    150,    180,    210 }, true  }, },
    ['tension_spring_iv']   = { { xi.mod.ATTP,                        {    150,    180,    210,    240 }, true  },
                                { xi.mod.RATTP,                       {    150,    180,    210,    240 }, true  }, },
    ['tension_spring_v']    = { { xi.mod.ATT,                         {    500,    750,   1000,   1250 }, true  },
                                { xi.mod.RATT,                        {    500,    750,   1000,   1250  }, true  },
