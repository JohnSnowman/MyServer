...
xi.job_utils.dragoon.addWyvernExp = function(player, exp)
    ...
    if prevExp < 1000 then
        ...
        if numLevelUps ~= 0 then
            ...
            wyvern:addMod(xi.mod.ACC, 12 * numLevelUps)
            wyvern:addMod(xi.mod.HPP, 12 * numLevelUps)
            wyvern:addMod(xi.mod.ATTP, 12 * numLevelUps)
            wyvern:addMod(xi.mod.DEFP, 20 * numLevelUps)
            wyvern:addMod(xi.mod.MDEF, 10 * numLevelUps)
            wyvern:addMod(xi.mod.MEVA, 25 * numLevelUps)
            ...
            player:addMod(xi.mod.ATTP, 12 * numLevelUps)
            player:addMod(xi.mod.DEFP, 12 * numLevelUps)
            player:addMod(xi.mod.HASTE_ABILITY, 350 * numLevelUps)
