...
--  Attachment                    Modifier                                0,       1,     2,     3    Optic Fiber Bonus
    ...
    ['auto-repair_kit']     = { { xi.mod.HPP,                         {     50,     50,     50,     50 }, false },
                                { xi.mod.REGEN,                       {    nil,    nil,    nil,    nil }, true  }, },
    ['auto-repair_kit_ii']  = { { xi.mod.HPP,                         {    100,    100,    100,    100 }, false },
                                { xi.mod.REGEN,                       {    nil,    nil,    nil,    nil }, true  }, },
    ['auto-repair_kit_iii'] = { { xi.mod.HPP,                         {    150,    150,    150,    150 }, false },
                                { xi.mod.REGEN,                       {    nil,    nil,    nil,    nil }, true  }, },
    ['auto-repair_kit_iv']  = { { xi.mod.HPP,                         {    200,    200,    200,    200 }, false },
                                { xi.mod.REGEN,                       {    nil,    nil,    nil,    nil }, true  }, },
    ...
    ['mana_booster']        = { { xi.mod.AUTO_MAGIC_DELAY,            {      6,      9,     12,     18 }, false },
                                { xi.mod.FASTCAST,                    {     65,     70,     75,     80 }, true  },
                                { xi.mod.UFASTCAST,                   {     3,       8,     13,     18 }, false  }, },
    ...
    ['mana_jammer_iv']      = { { xi.mod.MDEF,                        {    400,    500,    600,    700 }, true  }, 
                                { xi.mod.DMG,                         {  -5000,  -5500,  -6000,  -7000 }, true  }, },
    ['mana_tank']           = { { xi.mod.MPP,                         {     50,     50,     50,     50 }, false },
                                { xi.mod.REFRESH,                     {    nil,    nil,    nil,    nil }, true  }, },
    ['mana_tank_ii']        = { { xi.mod.MPP,                         {    100,    100,    100,    100 }, false },
                                { xi.mod.REFRESH,                     {    nil,    nil,    nil,    nil }, true  }, },
    ['mana_tank_iii']       = { { xi.mod.MPP,                         {    150,    150,    150,    150 }, false },
                                { xi.mod.REFRESH,                     {    nil,    nil,    nil,    nil }, true  }, },
    ['mana_tank_iv']        = { { xi.mod.MPP,                         {    200,    200,    200,    200 }, false },
                                { xi.mod.REFRESH,                     {    nil,    nil,    nil,    nil }, true  }, },
